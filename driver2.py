...
if __name__ == '__main__':
    ...
    for filename in xmllist:
        ...
        print 'Output to '+htmPath+os.path.basename(filename).split('.')[0].lower()+'.htm'
        ...
        print "<a href=\""+os.path.basename(filename).split('.')[0].lower()+".htm\">"+os.path.basename(filename).split('.')[0].lower()+".htm</a><br/>"
        sys.stdout = consoleOutputAddress
